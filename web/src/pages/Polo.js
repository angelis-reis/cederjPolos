		...
		<div id='page-polo'>
			...
			<main>
				<div className='polo-details'>
					<img
						src={polo.images[activeImageIndex].url}
						alt={polo.name}
					/>
						...
						<div className='map-container'>
							...
							>
								...
								<Marker
									interactive={false}
									icon={mapIcon}
									position={[polo.latitude, polo.longitude]}
								/>
							</Map>
							...
							<footer>
								<a
									...
									href={`https://www.google.com/maps/dir/?api=1&destination=${polo.latitude},${polo.longitude}`}
								>
